...
const App = () => {
  ...
  // Funcionalidad 2: Crear una nueva tarea (POST /tasks)
  ...
  // Funcionalidad 3: Marcar tarea como completada (PUT /tasks/{id})
  const toggleTaskCompleted = async (task) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/tasks/${task.id}`, {
        ...
        // Enviamos los campos necesarios para actualizar
        body: JSON.stringify({
  ...
  // Funcionalidad 4: Eliminar una tarea (DELETE /tasks/{id})
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-4 font-sans">
      <div className="w-full max-w-lg bg-white shadow-xl rounded-xl p-6 md:p-8 mt-10">
        ...
        {/* Formulario de Nueva Tarea (Crear) */}
